...
public class AnalogClockControl : Control
{
    ...
    public static readonly StyledProperty<IBrush?> ForegroundProperty =
        AvaloniaProperty.Register<AnalogClockControl, IBrush?>(nameof(Foreground), defaultValue: Brushes.Black);
    ...
    public override void Render(DrawingContext context)
    {
        ...
        var foreground = this.Foreground ?? (isDark ? Brushes.White : Brushes.Black);
