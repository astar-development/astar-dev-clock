...
This is a cross‑platform C# project (targeting .NET 9 / Avalonia 11) that displays an analog clock with a light and dark theme. It should run on Linux Mint, as well as other desktop OSes supported by
.NET and Avalonia.
